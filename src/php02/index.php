...
<body>
    <header class="header">
        <div class="header__inner">
            <a class="header__logo" href="/php2/index.php">
                World Clock
            </a>
        </div>
    </header>
